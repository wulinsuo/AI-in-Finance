...
\end{align*} The signal adds real value on this small sample, both a higher average return and a more consistent one, even though it is wrong nearly a quarter of the time. Turning this signal into an actual executed position, at the right size and without excessive market impact\index{market impact}, is the execution problem Chapter 13 developed in detail.
