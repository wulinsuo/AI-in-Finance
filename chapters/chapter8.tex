...
\section{Value at Risk: Parametric and Historical Methods}
\label{sec:var}
...
\subsection{Portfolio VaR with the Variance-Covariance Matrix}
...
\section{Expected Shortfall: Going Beyond VaR}
...
\section{Monte Carlo Simulation for Risk Measurement}
...
\section{Backtesting Value at Risk Models}
...
\section{Liquidity Risk and Liquidity-Adjusted VaR}
...
\subsection{Climate Risk: Physical and Transition Scenarios}
...
Because physical and transition risk require inputs no financial statement provides directly, asset-level carbon emissions, exposure to specific flood or wildfire zones, sector transition pathways, this is also where the alternative data sources of Chapter 17 and the NLP-based disclosure analysis of Chapter 16 increasingly feed directly into risk management: satellite imagery estimates physical exposure at a specific facility's coordinates, and text analysis of a company's own climate disclosures can flag transition-risk exposure a coarse sector label alone would miss.

\section{Machine Learning Applications in Market Risk}
...
\section{Model Validation and Model Risk Management}
...
\section{Risk Governance: The Three Lines of Defense}
