...
A firm creates value when it earns returns on invested capital that exceed the cost of that capital. This is one of the most important ideas in corporate finance. If a company invests in projects that earn more than the required return, value is created. If it invests in projects that earn less than the required return, value is destroyed. A common way to express this is through economic profit\index{Economic Profit},
\begin{equation*}
...
Ratios can also be combined into a single index designed to predict financial distress. The best known example is Altman's Z-score\index{Altman's Z-Score}; for a private (non-publicly-traded) firm like Meridian, the Z$'$-score variant is
\begin{equation*}
