...
\subsection{Pricing Default Risk}
...
\section{Interest Rate Risk: Using Duration to Approximate Price Changes}
...
\section{The Cost of Capital: CAPM\index{Capital Asset Pricing Model (CAPM)} and WACC}
\label{sec:wacc}
...
\subsection{Preferred Stock: A Perpetuity Special Case}
...
\section{Relative Valuation: Multiples}
...
\section{No-Arbitrage Pricing and the Binomial Option Model}
...
\subsection{Extending to Two Steps}
...
\subsection{American Options and Early Exercise}
...
\section{The Greeks: Measuring an Option's Risk Exposures}
...
phase passes, exactly the volatility clustering and mean reversion that Chapter 7's GARCH(1,1) recursion models directly.
...
\section{Real Options: Applying Option Pricing to Corporate Decisions}
...
the ``strike price'' is the cost of taking the action, and volatility in the underlying business or commodity price plays exactly the same role it plays in the
