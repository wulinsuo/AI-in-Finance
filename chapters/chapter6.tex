...
\section{Regression: A Worked Example}
...
\section{How Models Learn: Gradient Descent}
...
\section{Classification: A Worked Example}
...
\section{$K$-Nearest Neighbors: A Non-Parametric Classifier}
...
\section{Bias, Variance, and the Tradeoff}
...
\section{Practical Considerations in Financial ML}
...
\section{Feature Engineering for Financial Data}
...
\section{Naive Bayes: A Probabilistic Classifier}
...
\section{Neural Networks and Deep Learning in Finance}
