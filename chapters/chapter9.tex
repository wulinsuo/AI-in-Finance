...
The practical distinction between the two framings is one of purpose rather than substance: the pricing framing of Chapter 5 asks ``what should this bond be worth today,'' while the expected-loss framing here asks ``how much of this exposure should a lender expect to lose, on average, and how much capital or loan-loss reserve should be held against that possibility,'' which is exactly the accounting and regulatory question addressed later in this chapter.
