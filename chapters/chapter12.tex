...
\subsection{A Brief History of Portfolio Theory}
...
\section{Diversification and the Power of Combining Assets}
...
\section{The Efficient Frontier and the Minimum-Variance Portfolio}
...
\section{Mean-Variance Optimization in Matrix Form}
...
\subsection{Shrinkage Estimation of the Covariance Matrix}
\label{sec:shrinkage}
...
\section{The Capital Asset Pricing Model and Beta Estimation}
\label{sec:capm-beta}
...
\section{The Capital Market Line and the Sharpe Ratio}
...
\section{Multi-Factor Models: Beyond a Single Market Beta}
...
\section{Risk Parity: A Correlation-Light Alternative}
...
\section{Black-Litterman: Blending Views with Market Equilibrium}
...
\section{Practical Allocation Decisions: Constraints, Rebalancing, and Transaction Costs}
...
\section{Tracking Error and the Information Ratio}
...
\section{Machine Learning in Portfolio Construction}
...
\section{International Diversification and Currency Risk}
...
\section{Case Vignette: From the 60/40 Portfolio to the Endowment Model}
