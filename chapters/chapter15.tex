...
\section{The Landscape of Financial Crime and Where AI Fits}
...
\subsection*{A Worked Example: The Bayes' Theorem Result at Full Transaction Volume}
...
\subsection*{The Threshold Choice: A Precision-Recall Trade-off}
...
\section{Advanced Models and Techniques for Class Imbalance}
...
\subsection*{Cost-Sensitive Learning: Class Weighting}
...
\subsection*{Resampling: Undersampling and SMOTE\index{SMOTE}}
...
\subsection*{More Expressive Models: Ensembles and Unsupervised Anomaly Detection}
...
\subsection*{Evaluating Models Under Imbalance: Precision-Recall AUC, Not ROC-AUC\index{ROC curve}}
...
\section{Behavioral Risk Frameworks and Customer Risk Tiering}
...
\section{Survival Models: Time to Detection and Account Risk Over Time}
...
\section{Anti-Money Laundering: Structuring, Monitoring, and Regulation}
...
\subsection*{Placement, Layering, and Integration: A Network Example}
...
\section{Privacy-Preserving Collaboration: Federated Learning Across Institutions}
...
\section{Alert Economics and the Cost of Low Precision}
...
\section{Governance: Model Risk Management and the Three Lines of Defense}
...
\subsection*{Model Monitoring: Precision Drift and Adversarial Adaptation}
