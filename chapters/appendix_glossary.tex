...
\item[\textbf{Survivorship bias}] The distortion introduced by analyzing only entities (companies, funds, strategies) that still exist today, silently excluding the failures that were removed along the way. See Chapter 15.
