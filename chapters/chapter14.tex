...
\section{The Race to Zero: Latency, Co-location, and the Physics of Speed}
...
\section{Statistical Arbitrage at High Frequency: ETF-Basket Arbitrage}
...
\section{Market Making at High Frequency: Extending the Inventory Model}
\label{sec:hf-inventory}

Chapter 13's Avellaneda-Stoikov example computed a market maker's optimal quote skew using a time horizon $T-t$ of a full unit (one day, in that illustration). High-frequency market making applies exactly the same formula,
\begin{equation*}
...
\section[A Worked Example: Daily Profit and Loss]{A Worked Example: Daily Profit and Loss from High-Frequency Market Making}
\label{sec:hf-pnl}
...
\section{Cross-Market Latency Arbitrage: Futures Leading the Cash Market}
...
\section{The Economics of Co-location: A Break-Even Calculation}
...
\section{Order-to-Trade Ratios and the Economics of Message Traffic}
...
\section{Queue Position and the Economics of Price-Time Priority}
...
\section{Direct Data Feeds, the Consolidated Tape, and Reg NMS\index{Regulation NMS (Reg NMS)}}
...
\section{Measuring Market Quality: Effective Spreads and Price Discovery}
...
\section{Predictive Modeling: Order Flow Imbalance}
\label{sec:ofi}
...
\section{The Decision Pipeline, and Machine Learning's Latency Cost}
...
\subsection{Concept Drift and Model Retraining at High Frequency}
...
\section{Risk Controls: Kill Switches and Pre-Trade Risk Checks}
