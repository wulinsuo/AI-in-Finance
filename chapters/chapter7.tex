...
\section{Why Time Series Analysis Matters in Finance}
...
\section{Stationarity, White Noise, and Random Walks}
...
\section{Testing for Stationarity: The Augmented Dickey-Fuller Test}
\label{sec:adf-test}
...
\section{A Worked Example: Fitting and Forecasting an AR(1) Model}
...
\section{Multi-Step Forecasting and the Growth of Uncertainty}
...
\section{Vector Autoregression: Modeling Several Series Jointly}
...
\section{A Worked Example: PCA and Forecasting the Term Structure of Interest Rates}
...
\section{Volatility Clustering and the GARCH Family}
\label{sec:garch}
