...
Sequential decision-making & Executing a trade over time to minimize impact, formalized as a Markov decision process & Ch.~11, 12, 17 \\
...
Finally, the case vignette in Section 1.19 is worth revisiting after finishing the book: a reader who initially finds the asset-management example abstract should be able to return to it once Chapters 4, 6, 7, 8, 10, 11, and 14 have been covered and see exactly how each step would be implemented in practice.
