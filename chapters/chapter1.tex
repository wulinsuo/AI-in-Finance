...
\section{A Short History of Quantitative Methods and AI in Finance}
...
\section{A Brief Introduction to Financial Markets}
...
\section{Core Financial Concepts}
...
\section{Financial Problems That AI Can Help Solve}
...
\section{Financial Statements, Cash Flows, and Valuation}
...
\section{Why Finance Is Not Just a Collection of Numbers}
...
\section{A Practical Perspective on the Role of AI in Finance}
...
\section{Connecting the Foundations to Later Chapters}
...
\section{Finance as a System of Incentives and Information}
...
\section{Uncertainty, Probability, and Decision-Making}
...
The reason this question is nontrivial, rather than simply ``bet as much as a positive edge allows,'' is that wealth wagered repeatedly compounds rather than accumulates. A single bet's expected value is an arithmetic average across outcomes, and it is exactly the right tool for deciding whether to take that bet once.
...
\section{Bayesian Updating: Learning from New Information}
...
\section{Why Models Must Be Interpreted, Not Worshipped}
...
\section{Case Vignette: How Classical Finance and AI Combine in Practice}
...
The data ecosystem in Section 1.5 previewed the range of data types, market, fundamental, macroeconomic, credit, text, and alternative, that later chapters draw on, each with its own quality issues.
...
Finally, the case vignette in Section 1.19 is worth revisiting after finishing the book: a reader who initially finds the asset-management example abstract should be able to return to it once Chapters 4, 6, 7, 8, 12, 13, and 16 have been covered and see exactly how each step would be implemented in practice.
