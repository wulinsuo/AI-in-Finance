...
\subsubsection*{Types of Financial Risk}
...
\subsubsection*{Value at Risk: Parametric and Historical Methods}
\label{sec:var}
...
\subsubsection*{Expected Shortfall: Going Beyond VaR}
...
\subsubsection*{Maximum Drawdown: A Path-Dependent Risk Measure}\index{Maximum drawdown}
...
\subsubsection*{Monte Carlo Simulation for Risk Measurement}
...
\subsubsection*{Backtesting Value at Risk Models}
...
\subsubsection*{Liquidity Risk and Liquidity-Adjusted VaR}
...
\subsubsection*{Sensitivity-Based Risk Limits}\index{Sensitivity-based risk limits}
...
\subsection{The Greeks as Limits in Their Own Right}
...
\subsection{Bucketed Sensitivities: The DV01 Ladder}\index{DV01}
...
\subsection{Computing Sensitivities at Scale: Adjoint Differentiation}\index{Adjoint algorithmic differentiation}
\label{sec:aad}
...
\subsection{Hedging: Removing an Exposure You Do Not Want}\index{Delta Hedging}
...
\subsection{Position Sizing: Controlling Risk Before It Exists}\index{Volatility targeting}
...
\subsection*{Stop-Losses and Drawdown Triggers, and Why They Disappoint}\index{Stop-loss}
