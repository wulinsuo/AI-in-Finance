...
\subsubsection*{A Worked Example: TF-IDF for Four Earnings-Call Sentences}\index{TF-IDF for Four Earnings-Call Sentences}
...
Counting occurrences of the six vocabulary words in each sentence, and applying Chapter 6's Section 6.6.2 Laplace (add-one) smoothing correction, gives the estimated word probabilities
\begin{align*}
