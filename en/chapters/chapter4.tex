...
\begin{lrbox}{\bookmeasuredbox}
    \begin{tikzpicture}[>=latex,thick,node distance=1.1cm]
        ...
        \node[draw,rounded corners,minimum width=3.0cm,minimum height=0.9cm,below=1.3cm of is,align=center] (bs2) {Balance Sheet\\(End of Period)};
        \draw[->] (bs1) -- (is);
        \draw[->] (is) -- (cf);
        \draw[->] (is) -- (bs2);
        \draw[->] (cf) -- (bs2);
