...
\subsubsection*{Why Time Series Analysis Matters in Finance}
...
\subsubsection*{Stationarity, White Noise, and Random Walks}
...
\subsection{Confidence Intervals and $p$-Values for Model Parameters}
\label{sec:ci-pvalue}
